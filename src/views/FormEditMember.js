...
import { GETUSER, CREATEMEMBER, GETMEMBERBYID, UPDATEMEMBER } from '../utils/url'
                        ...
                        <Row form>
                          <Col md="4" className="form-group">
                            ...
                            <FormInput
                              ...
                              defaultValue={member.tempat_lahir}
...
export default withRouter(FormAddMember);
