...
import { GETMEMBERBYADMINUPDATE, GETUSER, GETPOSITION, GETPROVINSIBYID, GETDAERAHBYID } from '../utils/url'
import { user } from '../utils/auth'
import axios from 'axios';

const VerifikasiUpdate = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const memberPagRes = await (await axios.get(GETMEMBERBYADMINUPDATE + "/" + localStorage.getItem("user"))).data
...
export default VerifikasiUpdate;
